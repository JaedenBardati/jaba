...
if __name__ == "__main__":
  ...
  time.sleep(1)
  update_global_timer(start_text="Last one . . .", end_text="hey, it's been {:0.1f} seconds.\n")
  time.sleep(2)
  stop_global_timer()
  ...
  time.sleep(1)
  globally_time(1, start_text="Last one . . .", end_text="hey, it's been {:0.1f} seconds.\n")
  time.sleep(2)
  globally_time(2)
  ...
  time.sleep(1)
  log_timing(start_text="Last one . . .", end_text="hey, it's been {:0.1f} seconds.\n")
  time.sleep(2)
  log_timing()
